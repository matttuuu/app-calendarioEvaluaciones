...
public class MyGridAdapterEducacion extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (displayMonthEdu == currentMonthEdu && displayYearEdu == currentYearEdu){
            view.setBackgroundColor(getContext().getResources().getColor(R.color.lightpink)); //PARA CAMBIAR EL COLOR RESALTADOS DE LOS DÍAS DEL MES. EL COLOR ESTA ALOJADO EN RES/VALUES/COLORS.XML
        }
        else {
