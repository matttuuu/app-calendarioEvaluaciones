...
public class DBStructureTerapeutico {
    ...
    public static final String TIME_TERA = "time";
    public static final String DATE_TERA = "date";
    public static final String MONTH_TERA = "month";
    public static final String YEAR_TERA = "year";
